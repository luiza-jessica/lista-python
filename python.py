...
def dias_perdidos_por_fumar(cigarros_fumados_por_dia, anos_fumando):
    """ Recebe uma quantidade de cigarros fumados por dia e a quantidade
     ...
     cada cigarro reduz a vida em 10 minutos."distancia/velocidade""
     Dias = anos_fumando * 365 distancia/velocidade
     Minutos = cigarros_fumados_por_dia * 10 distancia/velocidade
     X = Minutos / 1440 distancia/velocidade
     dias_perdidos_por_fumar = x * Dias distancia/velocidade
     return round(dias_perdidos_por_fumar, 2)distancia/velocidade
distancia/velocidade
distancia/velocidade
def dois_elevado_a_um_milhao():distancia/velocidade
...
def media_final_aprovado_reprovado(p1, p2, ep1, ep2):
    """ Recebe as notas das 2 provas e 2 exercíciodef soma_dois_inteiros(a, b):
    """ Recebe dois números inteiros, e retorna a sua soma"""
    soma = a + b
    return = soma
...
def salario(valor_hora, horas_mensais):
    ...
    desconto2 = salario * 0.11
    desconto3 = salario * 0.05 
    salario líquido = salario - (desconto1 + desconto2 + desconto3)
    return salario líquido
...
def main():
    ...
    test(madef soma_dois_inteiros(a, b):
    """ Recebe dois números inteiros, e retorna a sua soma"""
    soma = a + b
    return = soma
...
def dias_perdidos_por_fumar(cigarros_fumados_por_dia, anos_fumando):
    """ Recebe uma quantidade de cigarros fumados por dia e a quantidade
     de anos que fuma, e retorna o total de dias perdidos, sabendo que
     cada cigarro reduz a vida em 10 minutos."distancia/velocidade""
     Dias = anos_fumando * 365 distancia/velocidaderogramação e retorna
    se o aluno foi ou não aprovado. As provas têm def soma_dois_inteiros(a, b):
    """ Recebe dois números inteiros, e retorna a sua soma"""
    soma = a + b
    return = soma
...
def dias_perdidos_por_fumar(cigarros_fumados_por_dia, anos_fumando):
    """ Recebe uma quantidade de cigarros fumados por dia e a quantidade
     de anos que fuma, e retorna o total de dias perdidos, sabendo que
     cada cigarro reduz a vida em 10 minutos."distancia/velocidade""
     Dias = anos_fumando * 365 distancia/velocidade e os exercícios
    têm peso 3. Cada parcial tem peso igual."""
    V = ((p1 + p2) * 7 / 10) + ((ep1 + ep2) * 3 / def soma_dois_inteiros(a, b):
    """ Recebe dois números inteiros, e retorna a sua soma"""
    soma = a + b
    return = soma
...
def salario(valor_hora, horas_mensais):
    """ Recebe quanto ganha por hora e quantas hordef soma_dois_inteiros(a, b):
    """ Recebe dois números inteiros, e retorna a sua soma"""
    soma = a + b
    return = soma
...
def dias_perdidos_por_fumar(cigarros_fumados_por_dia, anos_fumando):
    """ Recebe uma quantidade de cigarros fumados por dia e a quantidade
     de anos que fuma, e retorna o total de dias perdidos, sabendo que
     cada cigarro reduz a vida em 10 minutos."distancia/velocidade""
     Dias = anos_fumando * 365 distancia/velocidadebalho ao mês,
    e retorna o salário líquido.
    Descontos:
    - INSS é 8% do salário bruto
    - IR é 11% do salário bruto
...
if __name__ == '__main__':
    ...
    if total == acertos:
        print("Parabéns, seu programa rodou sem falhas!")or_menor(lista2), (0, -1))
    test(madef soma_dois_inteiros(a, b):
    """ Recebe dois números inteiros, e retorna a sua soma"""
    soma = a + b
    return = soma
...
if __name__ == '__main__':
    ...
    if total == acertos:
        print("Parabéns, seu programa rodou sem falhas!")or_menor(lista3), (100, -100.1))
    test(madef soma_dois_inteiros(a, b):
    """ Recebe dois números inteiros, e retorna a sua soma"""
    soma = a + b
    return = soma
...
if __name__ == '__main__':
    ...
    if total == acertos:
        print("Parabéns, seu programa rodou sem falhas!")or_menor(lista4), (-1, -10))

    print('def soma_dois_inteiros(a, b):
    """ Recebe dois números inteiros, e retorna a sua soma"""
    soma = a + b
    return = soma
...
if __name__ == '__main__':
    ...
    if total == acertos:
        print("Parabéns, seu programa rodou sem falhas!")Média dos saltos em lista:')
    test(media_saltos_lista([10, 10, 10, 10, 10]), 10)
    test(media_saltos_lista([9, 9.1, 8, 7, 6.9]), 8)
    test(media_saltos_lista([1, 1, 3, 5, 5]), 3)
    test(media_saltos_lista([10, 10, 9.9, 10, 10]), 10)
